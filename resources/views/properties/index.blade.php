    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between gap-4">
            ...
            @can('create', App\Models\Property::class)
                <a href="{{ route('properties.create') }}" class="rounded-full bg-zinc-950 px-4 py-2 text-sm font-medium text-white dark:bg-white dark:text-zinc-950">Create Property</a>
            @endcan
        </div>
                ...
                <article class="rounded-[1.75rem] border border-white/70 bg-white/85 p-6 shadow-xl shadow-cyan-950/5 dark:border-white/10 dark:bg-white/5">
                    ...
                    @can('update', $property)
                        <div class="mt-6 flex items-center justify-between gap-3">
                            <a href="{{ route('properties.edit', $property) }}" class="text-sm font-medium text-cyan-700 dark:text-cyan-300">Manage property</a>
